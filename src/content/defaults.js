// ─────────────────────────────────────────────────────────────────────────────
// Default portfolio content (fallback / seed).
// At runtime the app fetches `content.json` (editable via the admin dashboard)
// and merges it over these defaults. Edit here to change the built-in baseline.
// ─────────────────────────────────────────────────────────────────────────────
...
export const defaultContent = {
  profile: {
    ...
    photo: "", // empty → use the bundled default photo
    resumeUrl: "#",
    socials: {
  ...
  mission: {
    statement:
      "Software Engineer specializing in backend development and cloud-native systems, with hands-on experience building scalable applications using .NET and modern cloud infrastructure. I design and deploy microservices-based systems on AWS — working with Kubernetes, Docker, and infrastructure-as-code tools like Terraform. I enjoy solving complex problems, optimizing performance, and building systems that scale, approaching challenges with both analytical thinking and practical execution.",
    focus: [
      "Cloud Engineering (AWS, Kubernetes)",
      "Backend Systems (.NET, Microservices)",
      "DevOps & Infrastructure Automation",
    ],
    openTo:
      "Open to opportunities in Backend Engineering, Cloud Engineering, and DevOps.",
  },
  ...
  skills: [
    { category: "Languages", items: ["C#", "SQL", "Python", "JavaScript", "TypeScript"] },
    {
      category: "Backend",
      items: [".NET Core", "ASP.NET Core", "REST APIs", "Microservices", "CQRS", "DDD", "Clean Architecture", "SOA", "gRPC"],
    },
    { category: "Frontend", items: ["React.js", "Angular"] },
    {
      category: "Data Access",
      items: ["EF Core", "Dapper", "PostgreSQL", "SQL Server", "MongoDB", "Redis", "Elasticsearch"],
    },
    {
      category: "Cloud & DevOps",
      items: ["AWS (EKS, EC2, RDS, SQS/SNS, IAM)", "Docker", "Kubernetes", "GitHub Actions", "Jenkins"],
    },
    {
      category: "Practices & Tools",
      items: ["TDD", "Code Reviews", "CI/CD", "Unit & Integration Testing", "Design Patterns", "Git", "Linux"],
    },
  ],
  ...
  experience: [
    {
      ...
      description: "Worked on production-grade, cloud-native deployments and infrastructure.",
      achievements: [
    ...
    },
    {
      ...
      description: "Led backend development and engineering practices for production systems.",
      achievements: [
    ...
    },
    {
      ...
      description: "Delivered targeted fixes and performance work on legacy .NET and SQL systems.",
      achievements: [
  ...
  achievements: [
    {
      ...
      detail: "Qualified to the finals of the Egyptian Collegiate Programming Contest (ICPC regional).",
    },
    {
      title: "600+ Problems Solved",
      detail: "Solved 600+ competitive-programming problems, sharpening algorithms and data-structures skills.",
    },
  ],
}

// The bundled fallback photo (used when profile.photo is empty).
export const fallbackPhoto = photoUrl
